...
#undef MBEDTLS_PLATFORM_STD_CALLOC // 禁用标准calloc
#undef MBEDTLS_PLATFORM_STD_FREE   // 禁用标准free
		  /**
		   ...
		   */
			...
			*/
			 ...
			 */
			  ...
			  */
			  #define MBEDTLS_SSL_OUT_CONTENT_LEN             6144
...
#define MBEDTLS_ECP_DP_SECP256R1_ENABLED
#define MBEDTLS_ECP_C
#define MBEDTLS_SSL_RECORD_CHECKING_OFF  
